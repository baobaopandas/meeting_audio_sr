...
if __name__ == '__main__':
    ...
    # print(speaker)
    results = getDiarization("audioTest_wav/test1.wav")
    print("before")
    for result in results:
        print(f"start={result.start_time}s stop={result.end_time}s {result.speaker}")
    print("after")
    for result in results:
        speaker = getSingleSpeaker("audioTest_wav/test1.wav",result.start_time,result.end_time)
